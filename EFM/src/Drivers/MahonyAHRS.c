...
#define sampleFreq	5800.0			// sample frequency in Hz
#define twoKpDef	(2.0 * 200.0)	// 2 * proportional gain
...
volatile double integralFBx = 0.0,  integralFBy = 0.0, integralFBz = 0.0;	// integral error terms scaled by Ki
